...
import com.ftouchcustomer.Profile.State.ClsState;
import com.ftouchcustomer.R;

import java.util.ArrayList;
import java.util.List;

import static com.ftouchcustomer.Global.ClsGlobal.countryStateCityCode;


public class CountryStateCityAdapter extends
        RecyclerView.Adapter<CountryStateCityAdapter.CountryHolder> implements Filterable {
